...
/***/ (function(module, exports) {
	...
	}
	{
	    ...
	    console.log(_a, _b, _c); // 1  2  undefined  如果没有配对成功，用默认值 undefined
	}
	{
	    var _a2 = void 0,
	        _b2 = void 0,
	    ...
	    console.log(_a2, _b2, _c2); // 1 2 [3, 4, 5, 6, 7, 8, 9]
	}
	{
	    var _a3 = void 0,
	        _b3 = void 0;
	    ...
	    console.log(_a3, _b3); // 1 2  对象解构赋值
	}
	// 使用场景 1, 变量交换
	{
	    var _a4 = 1,
	...
	// 使用场景2   选择性的接受某个变量
	{
	    ...
	    var _fun2 = _slicedToArray(_fun, 2);
	...
	}
	{
	    ...
	    var _fun4 = _slicedToArray(_fun3, 4);
	...
	//对象的解构赋值 (注意key对应)
	{
	    var obj = { a: 111, b: false, c: 'test' };
	    var _a8 = obj.a,
	        _b8 = obj.b,
	        _c3 = obj.c;

	    console.log(_a8, _b8, _c3); // 111 false "test"
	    var x = obj.x,
	        y = obj.y,
	        z = obj.z;
	...
	}
	{
	    ...
	    var esTitle = metaData.title,
	        ...
	        testTitle = _metaData$test[0].title;
